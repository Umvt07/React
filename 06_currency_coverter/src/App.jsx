...
function App() {
    ...
    const convert = () => {
        ...
        console.log((Number(amount))*(Number(currencyInfo[to])))
    };
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREdfpeLz9xWj02OpE3pqU4nnPR374G-A4V2A&s')`,
            }}
        >
